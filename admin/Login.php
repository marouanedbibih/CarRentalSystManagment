...
<body>
    <div class=" justify-content-center bg-light" style="height: 100vh;">
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form action="" method="post">
                        ...
                        <button class="au-btn au-btn--block au-btn--green bg-orange m-b-20" type="submit" name="btn-login" id="btn-login">
                            sign in
                        </button>
                    </form>
                </div>
